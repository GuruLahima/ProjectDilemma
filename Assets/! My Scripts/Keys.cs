namespace Workbench.ProjectDilemma
{
  public static class Keys
  {
    ...
    public const string PLAYER_HARD_CURRENCY_POINTS = "HARD_CURRENCY_POINTS";
    ...
    // Game Foundation keys
    public const string THROWABLES_TAG = "throwables";
    public const string EMOTES_TAG = "emotes";
