...
namespace Workbench.ProjectDilemma
{
  ...
  public class DataPersistenceManager : MonoBehaviour
  {
    ...
    [Button("Reset GameFoundation data (works in play mode)")]
    public void ClearData()
    {
      ...
      // Debug.Log(localPersistence.fullpath);
    ...
    private void SubscribeToGameFoundationEvents()
    {
      ...
      if (!m_SubscribedFlag)
      {
        ...
        GameFoundationSdk.wallet.balanceChanged += OnBalanceChanged;
        GameFoundationSdk.rewards.rewardItemClaimSucceeded += OnRewardClaimed;
    ...
    private void OnRewardClaimed(Reward arg1, string arg2, Payout arg3)
    {
      Save();
    }
    ...
    /// </param>
    private void OnBalanceChanged(IQuantifiable quantifiable, long _)
    {
      Save();
    }
    #endregion
